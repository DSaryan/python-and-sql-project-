use hr;
                 /*     Assigement 1
/*              .... HR database Exerciese...
     /*1 write a query to display the name ( first_nmae, last_name) using alias name "First name" , "Last name "
     */
     select
     ...
     */
       ...
       /* 3 write a query to get all employee datails from the employee table order by first nmae , descending
       */
       select * from employees order by first_name desc;
       
       /* 4 write a query to get the name (first_name, last_name), salary , PF of all employees (PF is calculated as % of salary)
       */
       select first_name, last_name, salary*.15 PF from employees;
...
/*7 write a query to get the maxium and minimum salary from employees table 
*/ 
select max(salary) , min(salary) 
from employees;

/* 8 write a query to get the average salary and number of empolyees in the employees table 
*/ 
select avg(salary), count(*) from employees;

/* 9. write query to get the number of employees working with the company 
*/ 
select count(*) from employees;



/* 10. write a query to get the number to job available in the company
 */ 
